            ...
            {clients.map(c => (
              <tr key={c.id} className="hover:bg-slate-50">
                <td className="px-4 py-3">
                  <Link to={`/clients/${c.id}`} className="font-medium text-red-600 hover:underline">{c.name}</Link>
                </td>
                ...
                <td className="px-4 py-3 text-right space-x-2">
                  <button onClick={() => openEdit(c)} className="text-xs text-slate-500 hover:text-red-600">Edit</button>
